  ...
  return (
    <div className='bottomBox'>
     ...
     <div className='Btop flex'>
         <div className='Tleft'>
             <h2 className='white'>Top companies choose <span className='purple'>Edura Business</span> to build in-demand career skills.</h2>
         </div>
     ...
     <div className='Bmiddle flex'>
         <div className='Mleft white flex'>
             <ul >
                 <li>Edura Business</li>
                 <li>Teach on Edura</li>
                 <li>Get the app</li>
                 <li>About us</li>
                 <li>Contact us</li>
