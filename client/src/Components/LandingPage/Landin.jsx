              ...
              <div className="data-cont">
                ...
                <div className="skill-hub">
                  <div className="skill-desc">
                    ...
                    <p>
                      Take one of Edura's range of Python courses and learn how
              ...
              <div className="poster-cont">
                ...
                <div>
                  <PitchCard
                    ...
                    des={
                      "Instructors from around the world teach millions of students on Edura. We provide the tools and skills to teach what you love."
                    }
  ...
  return (
    <div className="pitch-cont">
      ...
      <p className="pitchdec">
        Get unlimited access to 6,000+ of Edura top courses for your team.
